...
int main(int argc, char *argv[]){
    ...
    if (N >= 2 && size % 2 == 0) { // con esto garantizamos que tengamos un numero de proceso "par" y ademas N sea >= 2 (haya al menos 4 procesos)
        ...
        printf("El numero de procesos no es par o no es mayor o igual a 4\n");
    }
